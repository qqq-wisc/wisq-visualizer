...
export function tileLayoutFromRouting(routing: Routing[], arch: Architecture, map: Mapping): TileLayout {
...
function generateBase(layout: TileLayout, arch: Architecture, map: Mapping): void {
...
function locaitonToCoordinate(location: number, arch: Architecture): coordinates {
